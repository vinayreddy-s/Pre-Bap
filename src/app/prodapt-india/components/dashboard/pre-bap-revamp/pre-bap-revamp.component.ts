...
import { WelfareFund } from 'src/app/prodapt-india/services/welfare-fund/welfare-fund.service';
import { UpdatePasswordDialogComponent } from '../../dialogs/update-password-dialog/update-password-dialog.component';

@Component({
  selector: 'app-pre-bap-revamp',
  templateUrl: './pre-bap-revamp.component.html',
  styleUrls: ['./pre-bap-revamp.component.scss']
})
export class PreBapRevampComponent implements OnInit {
